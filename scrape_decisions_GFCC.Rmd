...
pages <- c(1:721) # there are 721 pages to scrape (721 pages with each 10 decisions)
...
list_all_names <- c("Baer", "Böckenförde", "Britz", "Broß", "Bryde",
                    ...
                    "Grimm", "Haas", "Harbarth", "Hassemer", "Hoffmann-Riem", "Hohmann-Dennhardt",
...
unique(levels(as.factor(check_names)))

#Still trailing whitespace:

chamber_decisions$richter_txt <- sum(grepl(" Hömig", chamber_decisions$richter_txt))
...
unique(levels(as.factor(check_names)))[49]
...
write.csv(chamber_decisions, file = "chamber_decision_cleaned.csv")
