...
for(i in 1481:1954){
  ...
  list_1481_1954[[i]] <-   data.frame(header = header, cite = cite, chamber_senate = chamber_senate, 
                                 judges_names = judges_names,
                                 judge1 = judge1, judge2 = judge2, judge3 = judge3,
                                 link_decision = link_decision)
...
df_1481_1954  <- do.call("rbind", list_1481_1954)

```

decision 1955 is a Venice Commission abstract summary. Not a real decision. Cannot find judge names.
...
for(i in 1956:length(decisions)){
  ...
  list_1956[[i]] <-   data.frame(header = header, cite = cite, chamber_senate = chamber_senate, 
                                 judges_names = judges_names,
                                 judge1 = judge1, judge2 = judge2, judge3 = judge3,
                                 link_decision = link_decision)
...
df_1956_6527  <- do.call("rbind", list_1956)

```


decision 6528 has no header where it names the judges.
...
for(i in 6529:length(decisions)){
  ...
  list_6529[[i]] <-   data.frame(header = header, cite = cite, chamber_senate = chamber_senate, 
                                 judges_names = judges_names,
                                 judge1 = judge1, judge2 = judge2, judge3 = judge3,
                                 link_decision = link_decision)
...
df_6529_7176  <- do.call("rbind", list_6529)
